...
const KPICard = ({ icon: Icon, value, label, subtext, color, delay }: KPICardProps) => (
  <div
    className="bg-card rounded-2xl border border-border p-5 flex flex-col gap-3 animate-fade-in shadow-sm"
    style={{ animationDelay: `${delay}ms`, animationFillMode: 'backwards', borderBottom: `3px solid ${color}` }}
  >
